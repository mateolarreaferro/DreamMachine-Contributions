...
public class FFTGrandManager : MonoBehaviour
{
    ...
    float[][] _bandBuffer = new float[3][]; //****

    float[][] _bufferDecrease = new float[3][]; //****
    ...
    //2) FFT OUTPUT
    //Objects
    GameObject[][] _samplesAsObjects = new GameObject[3][]; //****
    ...
    [Tooltip("Height")]
    public float yOffset; //indicates where in the y axis the objects will appear
